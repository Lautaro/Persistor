...
public class GrowingSphereManager : MonoBehaviour
{
    public GrowingSphere rootSphere; // Assign in inspector
    ...
    void Start()
    {
        ...
        DestroyImmediate(spherePrefab.GetComponent<GrowingSphereManager>());
    }
    ...
    void SpawnSphere()
    {
        ...
        var allSpheres = GrowingSphere.AllSpheres
            .Where(s => s.gameObject != spherePrefab && s.Level >= 0 && s.Level < GrowingSphere.MaxLevel)
            .ToList();
        ...
        // Register as child and get GrowingSphere
        var newSphere = newObj.GetComponent<GrowingSphere>();
