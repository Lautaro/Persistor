...
public class PersistorGrowingSphere : PersistorMonoBehaviour
{
    ...
    public static List<PersistorGrowingSphere> AllSpheres { get; } = new();
    [Persist] public List<PersistorGrowingSphere> Children { get; set; } = new();
    ...
    { 
        ...
        if (rend != null)
        {
            ...
            int parentOrder = 0;
            var parentSphere = transform.parent ? transform.parent.GetComponentInParent<PersistorGrowingSphere>() : null;
    ...
    public override void OnDestroy()
    {
        ...
        var parent = transform.parent ? transform.parent.GetComponentInParent<PersistorGrowingSphere>() : null;
        if (parent != null)
